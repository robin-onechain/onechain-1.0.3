...
--assign coins
--move-call sui::coin::destroy_zero<one::oct::OCT> coins.0
...
--move-call sui::coin::destroy_zero<one::oct::OCT> zcoins.0
--move-call sui::coin::destroy_zero<one::oct::OCT> zcoins.1
